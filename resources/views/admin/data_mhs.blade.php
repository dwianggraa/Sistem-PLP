                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <li class="list-inline-item">
                                                                <a href="{{ url('/datamhs/edit', $item->id) }}"
                                                            ...
                                                            <li class="list-inline-item">
                                                                <a href="{{ url('/datamhs/delete', $item->id) }}"
                                    ...
                                    <a href="/datasiswa/create"><button type="button" class="btn btn-primary">Tambah Data SMK</button></a>
                                    @endif
                                    <h4></h4>
                                </tbody>
                            </table>
