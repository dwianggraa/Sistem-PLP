                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Edit Data SMK</h3>
                                </div>
                                <div class="card-body">
                                    <form action="{{ url('datasmk/update', $data_smk->id) }}" method="post">
                                        @csrf
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="namasmk" type="text" name="namasmk"
                                                placeholder="name@example.com" value="{{ $data_smk->namasmk }}" />
                                            <label for="inputEmail">Nama SMK</label>
                                        </div>
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="alamat" type="text" name="alamat"
                                                placeholder="name@example.com" value="{{ $data_smk->alamat }}" />
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="akreditasi" type="type"
                                                        name="akreditasi" type="password" placeholder="Confirm password"
                                                        value="{{ $data_smk->akreditasi }}" />
                                        ...
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="jurusan" type="text" name="jurusan"
                                                placeholder="name@example.com" value="{{ $data_smk->jurusan }}" />
                                            <label for="inputEmail">Jurusan</label>
                                        </div>
                                        <div class="mt-4 mb-0">
                                            <div class="d-grid"><button class="btn btn-primary btn-block"
                                                    type="submit">Update Data SMK</button></div>
                                        </div>
                                    </form>
                                </div>
                            </div>
