        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Data SMK</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Data SMK yang telah bekerja sama dengan prodi PTI FILKOM
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    @foreach ($data_smk as $key => $item)
                                        <tr>
                                            <td>{{ $data_smk->firstItem() + $key }}</td>
                                            <td>{{ $item['namasmk'] }}</td>
                                            <td>{{ $item['npsn'] }}</td>
                                    ...
                                    @endforeach
                                    <a href="/datasmk/create"><button type="button" class="btn btn-primary">Tambah
                                            Data SMK</button></a>
                                    <h4></h4>
                                </tbody>
                            </table>
