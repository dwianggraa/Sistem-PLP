                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <form action="{{ url('verifikasidata', $datamhs->id) }}" method="post">
                                       @csrf
                                        ...
                                        <div class="form-floating mb-3">
                                            ...
                                            <select name="dospim" id="dospim" class="form-control js-example-basic-single form-sele">
                                            ...
                                            </script><label for="inputPasswordConfirm">Dosen Pembimbing</label>
                                        </div>
                                 

                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="telepon" type="number"
                                                    name="telepon" />
                                        ...
                                        <div class="form-floating mb-3">
                                            ...
                                            class="js-example-basic-single form-select" value="{{ $item->verifikasi}}">
