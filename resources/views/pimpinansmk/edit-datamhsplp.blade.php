                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <form action="{{ url('/verifikasidata-mhs-plp', $datamhs->id) }}" method="post">
                                        @csrf
                                        ...
                                        <div class="form-floating mb-3">
                                            ...
                                            <select name="gurupamong" id="gurupamong"
                                            ...
                                            </script><label for="inputPasswordConfirm">Guru
                                                Pamong</label>
                                        </div>
                                        {{-- <div class="form-floating mb-3">
                                            <input class="form-control" id="gurupamong" type="text"
                                                name="gurupamong" />
                                            <label for="inputPasswordConfirm">Guru Pamong</label>
                                    </div> --}}

                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="telepon" type="number" name="telepon" value="{{ $datamhs->telepongurupamong }}"/>
                                        ...
                                        <div class="form-floating mb-3">
                                            <select id="verifikasi" name="verifikasi"
                                                ...
                                                <option data-verifikasi="yes">Verifikasi</option>
                                                <option data-verifikasi="no">Tolak</option>
                                            </select><label for="verifikasi">Verifikasi</label>
                                        </div>
                                        <script>
                                        ...
                                        <div class="mt-4 mb-0">
                                            <div class="d-grid"><button class="btn btn-primary btn-block"
                                                    type="submit">Simpan Data</button></div>
                                        </div>
                                    </form>
                                </div>
                            </div>
