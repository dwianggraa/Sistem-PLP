                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Edit Data Dosen Pembimbing</h3>
                                </div>
                                <div class="card-body">
                                <form action="{{ url('datadosbing/update', $datadosbing->id) }}" method="post">
                                        @csrf
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="nama" type="text" name="nama"
                                                placeholder="name@example.com" value="{{$datadosbing->nama }}"/>
                                            <label for="inputEmail">Nama Dosen</label>
                                        </div>
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="nik" type="text" name="nik"
                                                placeholder="name@example.com" value="{{$datadosbing->nik}}"/>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="email" type="email" name="email"
                                                        placeholder="Masukkan email" value="{{$datadosbing->email}}"/>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="telepon" name="telepon"
                                                        type="number" placeholder="Masukkan Telepon" value="{{$datadosbing->telepon}}"/>
                                        ...
                                        <div class="mt-4 mb-0">
                                            <div class="d-grid"><button class="btn btn-primary btn-block" type="submit"
                                                    >Update Data Dosbing</button></div>
                                        </div>
                                    </form>
                                </div>
                            </div>
