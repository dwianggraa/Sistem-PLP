...
<head>
    ...
    <title>Edit Data Mahasiswa PLP </title>
                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Edit Data Mahasiswa PLP</h3>
                                </div>
                                <div class="card-body">
                                    <form action="{{ url('datamahasiswa/update', $datamhs->id) }}" method="post">
                                       @csrf
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="smk" type="type"
                                                        name="smk" placeholder="Create a password" value="{{$datamhs->smk }}"/>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="keminatan" type="type"
                                                        name="keminatan" type="password"
                                                        placeholder="Confirm password" value="{{$datamhs->keminatan }}"/>
                                        ...
                                        <div class="form-floating mb-3">
                                            ...
                                            <select name="gurupamong" id="gurupamong" class="form-control js-example-basic-single form-sele">
                                                @foreach ($datagurupamong as $item)
                                                <option style="color: black" value="{{ $item->nama}}">{{ $item->nama}}</option>
                                                @endforeach
                                            </select>
                                            <script>
                                                const gurupamong = $('#gurupamong').data('gurupamong');
                                                $('[name=gurupamong]').val(gurupamong);
                                            </script><label for="inputPasswordConfirm">Guru Pamong</label>
                                        </div>
                           

                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="telepongurupamong" type="number"
                                                    name="telepongurupamong"  value="{{$datamhs->datagurupamong }}"/>
                                                <label for="inputPasswordConfirm">Telepon</label>
                                        </div>

                                        <div class="mt-4 mb-0">
                                            <div class="d-grid"><button class="btn btn-primary btn-block" type="submit"
                                                    >Update Data Mahasiswa PLP</button></div>
                                        </div>
                                    </form>
                                </div>
                            </div>
