...
<head>
    ...
    <title>Tambah Data Guru Pamong </title>
                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Tambah Data Guru Pamong</h3>
                                </div>
                                <div class="card-body">
                                    <form action="/datagurupamong/create" method="post">
                                        @csrf
                                        ...
                                        <div class="mt-4 mb-0">
                                            <div class="d-grid"><button class="btn btn-primary btn-block" type="submit"
                                                    >Tambah Data Guru Pamong</button></div>
                                        </div>
                                    </form>
                                </div>
                            </div>
