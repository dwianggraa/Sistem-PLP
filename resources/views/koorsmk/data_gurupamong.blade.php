            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Data Guru Pamong SMKN 03 BATU</li>
                    </ol>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    @foreach ($datagurupamong as $key => $item)
                                        <tr>
                                            <td>{{ $datagurupamong->firstItem() + $key }}</td>
                                            <td>{{ $item['nama'] }}</td>
                                            <td>{{ $item['nik'] }}</td>
                                            <td>{{ $item['email'] }}</td>
                                            ...
                                            <td>
                                                ...
                                                <li class="list-inline-item">
                                                    <a href="{{ url('/datagurupamong/edit', $item->id) }}"
                                                        class="btn btn-success btn-sm rounded-0" type="button"
                                                        data-toggle="tooltip" data-placement="top" title="Edit"><i
                                                            class="fa fa-edit"></i></a>
                                                </li>
                                                <li class="list-inline-item">
                                                    <a href="{{ url('/datagurupamong/delete', $item->id) }}"
                                    ...
                                    @endforeach
                                    <a href="/datagurupamong/create"><button type="button"
                                            class="btn btn-primary">Tambah Data
                                            Guru Pamong</button></a>
                                    <h4></h4>
                                </tbody>
                            </table>
                        </div>
